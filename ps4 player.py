    ...
    while left > 0:
       ...
       if word == ".":
          ...
          if not isValidWord(word, hand, wordList):
             ...
             print "\"%s\" earned %d points. Your total score: %d points." \
%(word, getWordScore(word, n), total)
             hand = updateHand(hand, word)
             left = calculateHandlen(hand)
    return str("Run out of letters. Total score: " + str(total) + " points.")
...
def playGame(wordList):
    ...
    while True:
        print
        choice = raw_input("Enter n to deal a new hand, r to replay the last hand \
or e to end game: ")
        if choice == "n":
            prevHand = dealHand(n)
